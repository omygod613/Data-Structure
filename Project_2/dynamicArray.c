...
void removeAtDynArr(DynArr *v, int idx){
    ...
    /* Part I: when remove elements in the dynamic array,
     * the dynamic array would be smaller than the capacity, 
     * so following the instruction, modify the given functions
     * to shrink the array when a remove causes the size to be 1/3rd of the capacity
     */
